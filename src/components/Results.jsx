...
export default function Result({ userAnswer, startClickBtnHandler }) {
  ...
  const failureRate = (
    ((questionCount - correctAnswers - skipperdAnswers) / questionCount) *
    100
  ).toFixed(0);
  ...
  return (
    <div id="summary">
      ...
      <Btn
        ...
        style={{ fontSize: "32px", width: "200px", padding: "0" }}
        type="button"
        className="start"
      >
        <p>Back</p>
